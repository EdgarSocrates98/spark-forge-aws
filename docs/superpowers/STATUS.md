...
neutra de plataforma, auditadas por `tests/test_databricks_rule_audit.py`.
...
área `SF-ENV` 5 → 6, rotas determinísticas 99 → 101, vocabulário de `action.kind` 68 → 70,
...
vigiadas 249 → 253 (quatro páginas de `docs.databricks.com`). `python
