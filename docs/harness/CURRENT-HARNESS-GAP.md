...
- **Enforcement de tool policy FORA do processo Python, via hook `PreToolUse`** (§41):
  ...
  o que cobre as 54 tools num ponto só. O que resta é o que nunca passa por `call_tool`:
