...
Medido: **48** das tools `READ_ONLY` declaram algum argumento de caminho
...
**75** de 81 — as quinze `LOCAL_MUTATION` e as dez `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 81 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 81
