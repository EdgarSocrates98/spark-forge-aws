...
Medido: **52** das tools `READ_ONLY` declaram algum argumento de caminho
...
**84** de 90 — as dezenove `LOCAL_MUTATION` e as treze `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 90 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 90
