...
Medido: **36** das tools `READ_ONLY` declaram algum argumento de caminho
...
**55** de 56 — as onze `LOCAL_MUTATION` e as oito `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 56 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 56
