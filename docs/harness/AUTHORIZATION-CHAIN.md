...
Medido: **62** das tools `READ_ONLY` declaram algum argumento de caminho
...
**99** de 107 — as dezenove `LOCAL_MUTATION` e as treze `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 107 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 107
