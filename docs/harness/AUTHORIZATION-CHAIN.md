...
Medido: **51** das tools `READ_ONLY` declaram algum argumento de caminho
...
**82** de 88 — as dezoito `LOCAL_MUTATION` e as treze `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 88 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 88
