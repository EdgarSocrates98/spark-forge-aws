...
**77** de 83 — as quinze `LOCAL_MUTATION` e as treze `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 83 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 83
