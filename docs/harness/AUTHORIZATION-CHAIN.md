...
Medido: **55** das tools `READ_ONLY` declaram algum argumento de caminho
...
**87** de 95 — as dezenove `LOCAL_MUTATION` e as treze `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 95 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 95
