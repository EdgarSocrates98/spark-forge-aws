...
Medido: **59** das tools `READ_ONLY` declaram algum argumento de caminho
...
**95** de 103 — as dezenove `LOCAL_MUTATION` e as treze `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 103 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 103
