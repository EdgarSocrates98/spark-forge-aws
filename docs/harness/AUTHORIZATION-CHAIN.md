...
Medido: **33** das tools `READ_ONLY` declaram algum argumento de caminho
...
**52** de 53 — as onze `LOCAL_MUTATION` e as oito `CLOUD_MUTATION` declaram
...
> `CallPolicy.decide`, e o despacho é único para as 53 tools, então fechar ali
...
a cadeia antes de despachar. O ponto foi escolhido por ser **único**: as 53
