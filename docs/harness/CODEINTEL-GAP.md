...
lados — os arquivos `*.py` que `iter_source_files(root, "*.py")` entrega, **770** nesta árvore.
...
|---|---|---|---|---|---|
| `iter_source_files` | 2 | 466 | 805941 | 11849 | 102 |
...
Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2250987**;
...
**Contra o denominador do plano, o índice economiza 1333.5 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **239169** bytes. O `grep` pela definição contendo o fragmento continua menor
