...
Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2243926**;
...
**Contra o denominador do plano, o índice economiza 1329.3 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **238277** bytes. O `grep` pela definição contendo o fragmento continua menor
