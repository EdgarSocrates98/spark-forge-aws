...
lados — os arquivos `*.py` que `iter_source_files(root, "*.py")` entrega, **736** nesta árvore.
...
| `project_items` | 1 | 193 | 355851 | 2201 | 52 |
| `tool_class` | 1 | 187 | 380549 | 3529 | 73 |
| `authorize` | 2 | 376 | 482352 | 4426 | 49 |

Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2179923**;
...
**Contra o denominador do plano, o índice economiza 1291.4 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **228253** bytes. O `grep` pela definição contendo o fragmento continua menor
  (**11531** bytes), mas responde outra coisa — ele lista linhas de definição, e não diz que
