...
| `project_items` | 1 | 193 | 356138 | 2201 | 52 |
| `tool_class` | 1 | 187 | 380836 | 3529 | 73 |
| `authorize` | 2 | 376 | 483183 | 4426 | 49 |

Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2181328**;
...
**Contra o denominador do plano, o índice economiza 1292.3 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **228889** bytes. O `grep` pela definição contendo o fragmento continua menor
