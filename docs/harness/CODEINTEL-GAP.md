...
lados — os arquivos `*.py` que `iter_source_files(root, "*.py")` entrega, **748** nesta árvore.
...
| `project_items` | 1 | 193 | 357194 | 2201 | 52 |
| `tool_class` | 1 | 187 | 381892 | 3529 | 73 |
| `authorize` | 2 | 376 | 483183 | 4426 | 49 |

Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2183440**;
...
**Contra o denominador do plano, o índice economiza 1293.5 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **229338** bytes. O `grep` pela definição contendo o fragmento continua menor
