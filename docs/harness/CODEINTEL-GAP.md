...
lados — os arquivos `*.py` que `iter_source_files(root, "*.py")` entrega, **636** nesta árvore.
...
| `project_items` | 1 | 193 | 297592 | 2201 | 52 |
| `tool_class` | 1 | 188 | 28525 | 3181 | 74 |
| `authorize` | 4 | 897 | 415604 | 4426 | 107 |

Somadas as cinco perguntas: o índice devolve **2210** bytes; ler os arquivos custaria **1702263**;
...
**Contra o denominador do plano, o índice economiza 770.3 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **215378** bytes. O `grep` pela definição contendo o fragmento continua menor
