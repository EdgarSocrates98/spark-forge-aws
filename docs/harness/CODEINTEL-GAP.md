...
Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2194589**;
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **230136** bytes. O `grep` pela definição contendo o fragmento continua menor
