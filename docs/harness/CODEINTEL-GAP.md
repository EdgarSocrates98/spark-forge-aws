...
|---|---|---|---|---|---|
| `iter_source_files` | 2 | 466 | 696922 | 9249 | 102 |
| `looks_like_secret` | 2 | 466 | 198731 | 2722 | 85 |
| `project_items` | 1 | 193 | 258231 | 2201 | 52 |
| `tool_class` | 1 | 188 | 28525 | 2984 | 74 |
| `authorize` | 4 | 897 | 349748 | 4426 | 107 |

Somadas as cinco perguntas: o índice devolve **2210** bytes; ler os arquivos custaria **1532157**;
a saída do `grep` pelo nome, **21582**; a saída do `grep` pela definição, **420**.
...
**Contra o denominador do plano, o índice economiza 693.3 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **158329** bytes. O `grep` pela definição contendo o fragmento continua menor
