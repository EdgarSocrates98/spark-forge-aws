...
| `project_items` | 1 | 193 | 213064 | 1827 | 52 |
| `tool_class` | 1 | 188 | 28525 | 2563 | 74 |
| `authorize` | 4 | 897 | 275830 | 4426 | 107 |

Somadas as cinco perguntas: o índice devolve **2210** bytes; ler os arquivos custaria **1266076**;
...
**Contra o denominador do plano, o índice economiza 572.9 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **128249** bytes. O `grep` pela definição contendo o fragmento continua menor
