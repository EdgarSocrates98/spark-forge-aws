...
lados — os arquivos `*.py` que `iter_source_files(root, "*.py")` entrega, **494** nesta árvore.
...
| `project_items` | 1 | 193 | 236504 | 2170 | 52 |
| `tool_class` | 1 | 188 | 28525 | 2563 | 74 |
| `authorize` | 4 | 897 | 316211 | 4426 | 107 |

Somadas as cinco perguntas: o índice devolve **2210** bytes; ler os arquivos custaria **1450356**;
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **139085** bytes. O `grep` pela definição contendo o fragmento continua menor
