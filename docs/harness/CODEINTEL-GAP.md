...
| `authorize` | 4 | 897 | 412544 | 4426 | 107 |

Somadas as cinco perguntas: o índice devolve **2210** bytes; ler os arquivos custaria **1695381**;
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **204884** bytes. O `grep` pela definição contendo o fragmento continua menor
