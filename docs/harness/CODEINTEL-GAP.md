...
| `authorize` | 2 | 376 | 482991 | 4426 | 49 |

Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2181136**;
...
**Contra o denominador do plano, o índice economiza 1292.1 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **228888** bytes. O `grep` pela definição contendo o fragmento continua menor
