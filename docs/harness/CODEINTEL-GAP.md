...
Somadas as cinco perguntas: o índice devolve **2210** bytes; ler os arquivos custaria **1599885**;
...
**Contra o denominador do plano, o índice economiza 723.9 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **173482** bytes. O `grep` pela definição contendo o fragmento continua menor
