...
lados — os arquivos `*.py` que `iter_source_files(root, "*.py")` entrega, **750** nesta árvore.
...
| `authorize` | 2 | 376 | 485704 | 4426 | 49 |

Somadas as cinco perguntas: o índice devolve **1688** bytes; ler os arquivos custaria **2195661**;
...
**Contra o denominador do plano, o índice economiza 1300.7 vezes.** Contra a saída de um `grep`
...
- **O denominador C só funciona se você já souber o nome inteiro e certo.** Para fragmento, o
  ...
  no mesmo corpus, tem **230513** bytes. O `grep` pela definição contendo o fragmento continua menor
