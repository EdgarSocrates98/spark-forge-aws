...
| Superfície | CLI `sparkforge analyze/judge/case/next-step/resume/migrate`, as tools MCP, `rules/catalog/` | `evals/fase0.xml`, `evals/holdout/`, os 54 corpora de `fixtures/` |
