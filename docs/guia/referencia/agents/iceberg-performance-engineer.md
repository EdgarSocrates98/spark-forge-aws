...
# Agent `iceberg-performance-engineer`

Gargalo em tabelas Apache Iceberg no Glue Data Catalog e S3 - small files, delete files, snapshots, manifests, metadata planning, partition spec, sort order, writes, manutencao.

| Campo | Valor |
|---|---|
| Papel | coordenador |
| Arquivo de origem | `agents/iceberg-performance-engineer.md` |
