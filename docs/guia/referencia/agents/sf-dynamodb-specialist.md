...
# Agent `sf-dynamodb-specialist`

Modelar ou revisar DynamoDB.

| Campo | Valor |
|---|---|
| Papel | coordenador |
| Arquivo de origem | `agents/sf-dynamodb-specialist.md` |
| Ferramentas do host | Read, Grep, Glob, Bash |
| Áreas de regra | SF-DYNAMODB, SF-NOSQL, SF-API |

## Skills que ele usa

[`design-dynamodb-model`](../skills/design-dynamodb-model.md)
