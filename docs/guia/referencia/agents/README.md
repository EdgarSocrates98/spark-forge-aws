...
| [`glue-infra-reviewer`](glue-infra-reviewer.md) | Gargalo ou risco na definicao do job Glue e nao no codigo - worker type e numero, auto scaling, bookmark, retries, argumentos de job, observabilidade, Terraform, e como a state... |
