...
Memoria auditavel de agents.

| Campo | Valor |
|---|---|
| Papel | coordenador |
| Arquivo de origem | `agents/sf-memory-engineer.md` |
| Ferramentas do host | Read, Grep, Glob, Bash |
| Áreas de regra | SF-AGENTS, SF-REPORT |

## Skills que ele usa

[`design-agent-systems`](../skills/design-agent-systems.md), [`agentic-orchestration`](../skills/agentic-orchestration.md), [`token-efficient-agent`](../skills/token-efficient-agent.md), [`engineer-agent-memory`](../skills/engineer-agent-memory.md)
