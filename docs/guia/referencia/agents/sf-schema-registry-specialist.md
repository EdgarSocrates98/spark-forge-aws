...
# Agent `sf-schema-registry-specialist`
...
|---|---|
| Papel | coordenador |
| Arquivo de origem | `agents/sf-schema-registry-specialist.md` |
| Ferramentas do host | Read, Grep, Glob, Bash |
| Áreas de regra | SF-CONTRACT, SF-VALIDATION, SF-CATALOG |

## Skills que ele usa

[`design-data-architecture`](../skills/design-data-architecture.md), [`review-data-validation`](../skills/review-data-validation.md), [`analyze-functional-rules`](../skills/analyze-functional-rules.md)
