...
Aprofundamento sob demanda, não aqui: [`docs/aws/glue/6.0/README.md`](../../../aws/glue/6.0/README.md) é a porta de entrada, [`docs/aws/glue/6.0/decision-guide.md`](../../../aws/glue/6.0/decision-guide.md) sustenta "ficar na versão anterior" como resposta legítima, e [`docs/aws/glue/6.0/known-unknowns.md`](../../../aws/glue/6.0/known-unknowns.md) reúne o que ninguém mediu.
