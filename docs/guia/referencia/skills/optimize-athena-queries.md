...
# Skill `optimize-athena-queries`

Use quando for necessario otimizar consultas Athena, particionamento, Parquet, projection, federated query e custo.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/optimize-athena-queries/SKILL.md` |
