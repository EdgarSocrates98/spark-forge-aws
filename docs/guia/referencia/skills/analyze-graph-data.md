...
# Skill `analyze-graph-data`

Use quando for necessario modelar, analisar ou consultar dados em grafos, caminhos, comunidades e relacionamentos.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/analyze-graph-data/SKILL.md` |
