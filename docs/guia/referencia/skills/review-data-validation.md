...
| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/review-data-validation/SKILL.md` |
...
Mover, unificar ou remover um check muda o que é rejeitado. Um check que deixa de rodar deixa
de reprovar linha; um que muda de lugar passa a reprovar outra. Reduzir passadas sobre o dado é
