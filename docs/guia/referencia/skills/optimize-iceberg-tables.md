...
# Skill `optimize-iceberg-tables`

Use quando for necessario otimizar tabelas Apache Iceberg e catalogos.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/optimize-iceberg-tables/SKILL.md` |
