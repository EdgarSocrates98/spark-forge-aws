...
# Skill `analyze-analytics`

Use quando for necessario analisar dados, analytics, metricas, consultas, custos e qualidade.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/analyze-analytics/SKILL.md` |
