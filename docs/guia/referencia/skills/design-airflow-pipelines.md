...
# Skill `design-airflow-pipelines`

Use quando for necessario projetar ou revisar Airflow e pipelines DAG.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/design-airflow-pipelines/SKILL.md` |
