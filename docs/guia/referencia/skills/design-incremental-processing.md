...
Este é o desenho que decide **quais linhas existem**: a janela de lookback decide qual late
data entra, `replay_strategy` e `backfill_strategy` decidem o que é reprocessado, e
