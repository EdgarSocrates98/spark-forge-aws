...
# Skill `design-lambda-serverless`

Use quando for necessario projetar, analisar ou otimizar AWS Lambda, eventos, concorrencia e arquiteturas serverless.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/design-lambda-serverless/SKILL.md` |
