...
Conhecimento de fundo, sob demanda: [`knowledge/spark/spark4-migration.md`](../../../../knowledge/spark/spark4-migration.md) traz o que a fonte declara e marca como *a verificar* o que ela não declara. [`docs/aws/glue/6.0/spark4.md`](../../../aws/glue/6.0/spark4.md) é a leitura pelo lado do Glue.
