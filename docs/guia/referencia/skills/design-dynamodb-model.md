...
# Skill `design-dynamodb-model`

Use quando for necessario modelar DynamoDB, chaves, access patterns, indexes, capacity, streams e consistencia.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/design-dynamodb-model/SKILL.md` |
