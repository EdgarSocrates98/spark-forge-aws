...
# Skill `design-step-functions-orchestration`

Use quando for necessario desenhar, revisar ou validar AWS Step Functions, EventBridge, retries e workflows serverless.

| Campo | Valor |
|---|---|
| Arquivo de origem | `skills/design-step-functions-orchestration/SKILL.md` |
