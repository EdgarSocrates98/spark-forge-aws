...
| `headroom` | number | não | Folga declarada sobre o piso medido do `spark.executor.memoryOverhead` e do `spark.sql.broadcastTimeout` (0.2 = 20%). Sem ela o valor e o piso, sem folga nenhuma. |
