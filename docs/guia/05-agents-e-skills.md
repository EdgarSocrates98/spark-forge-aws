...
| "A consulta no Athena custa caro" | [`athena-query-optimizer`](referencia/agents/athena-query-optimizer.md) | `optimize-athena-queries` |
...
| "Quanto custa e qual capacidade escolher" | `sf-cost-reviewer` | [`tune-glue-job`](referencia/skills/tune-glue-job.md); veja também [Custo e capacidade](usos/custo-e-capacidade.md) |
...
| "Desenhar ou revisar orquestração de pipeline" | `sf-airflow-specialist`, `sf-step-functions-specialist` | `design-airflow-pipelines`, `design-step-functions-orchestration` |
