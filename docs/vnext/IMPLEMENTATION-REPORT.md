...
| **Glue Migration Lab** | `sparkforge.migration.glue` | Glue 4.0 ➔ 5.1 analyzer, S3A vs EMRFS detection, Migration Readiness Score (0-100), GO/NO-GO gate. |
...
| **Antigravity 2.0** | `.agents/rules/` & `plugins/` | Evidence-first, AWS Safety, Terraform Safety, Migration Safety. |

---

## 3. Invariants Preserved

1. **Deterministic Facts**: 21 extractors, 118 fact kinds, 0 hallucinated metrics.
2. **Deterministic Rules**: 52 catalog files evaluated via strict AST.
...
5. **Zero Breaking Changes**: Full backwards compatibility maintained with existing CLI and 5,463 baseline tests.
