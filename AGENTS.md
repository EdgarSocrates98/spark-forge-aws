...
**81 tools, 36 with `detail_level`** (recounted 2026-09-09) (`summary`, `normal`, `full`). Rule 28 of
...
has **187** rules (**152** executable), and the MCP surface is **81** tools. Count areas with
