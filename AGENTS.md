...
**103 tools, 38 with `detail_level`** (recounted 2026-09-14) (`summary`, `normal`, `full`). Rule 28 of
...
has **190** rules (**155** executable), and the MCP surface is **83** tools. Count areas with
