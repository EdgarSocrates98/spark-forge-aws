...
Os 44 extratores emitem 253 kinds distintos de fact, e só `collect *` toca a AWS. O
catálogo tem **177** regras de diagnóstico em YAML, **177 delas executáveis** (todas), cada uma
