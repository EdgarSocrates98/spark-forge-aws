...
Os 40 extratores emitem 238 kinds distintos de fact, e só `collect *` toca a AWS. O
catálogo tem **161** regras de diagnóstico em YAML, **161 delas executáveis** (todas), cada uma
