...
**fora do repositório** e reproduz as 132 fixtures golden byte a byte a partir do
...
constrói o artefato, instala num venv limpo e reproduz as 132 fixtures golden byte a byte.
