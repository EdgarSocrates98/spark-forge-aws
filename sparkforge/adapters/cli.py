...
_PHOTON_FLAG_HELP = (
    ...
    "databricks.photon.unresolved, exceto a que so exige plan.python_udf ou "
    "plan.aqe. Plano com operador Photon (fact plan.photon) liga a mesma recusa "
    "sem a flag e vence a declaracao: declarar 'off' diante dele vira divergencia "
    "'photon:'. Sem declaracao nem plano Photon, SF-ENV-006 avisa que regra de "
    "plano calada nao e evidencia. Sem --databricks, a declaracao vira "
    "divergencia 'photon:' e nao entra no runtime."
)
