...
TOOLS: dict[str, dict[str, Any]] = {
    ...
    "sparkforge_analyze_terraform": {
        "description": (
            ...
            "Este extrator NAO preenche `subject.snippet` (fica vazio), mas carrega "
    ...
    "sparkforge_judge": {
        "description": (
            ...
            "`subject`, `measured` e `evidence` vem do ARTEFATO; os demais campos "
            "(`explanation`, `proposed_change`, `sources`, `threshold` e os outros) vem "
            "do CATALOGO revisado. Em particular `subject.snippet` carrega a LINHA "
