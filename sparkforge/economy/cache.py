...
class ArtifactCache:
    ...
    def __init__(self, cache_dir: Optional[Path] = None, default_ttl_seconds: int = 86400) -> None:
        self.cache_dir = cache_dir or (Path.cwd() / ".sparkforge" / "cache")
        self.default_ttl = default_ttl_seconds
        self._memory_cache: dict[str, dict[str, Any]] = {}

    def _compute_key(self, namespace: str, inputs: dict[str, Any], engine_version: str = "0.5.0") -> str:
        serialized = json.dumps({"ns": namespace, "in": inputs, "v": engine_version}, sort_keys=True, default=str)
        return hashlib.sha256(serialized.encode("utf-8")).hexdigest()

    def get(self, namespace: str, inputs: dict[str, Any], engine_version: str = "0.5.0") -> Optional[Any]:
