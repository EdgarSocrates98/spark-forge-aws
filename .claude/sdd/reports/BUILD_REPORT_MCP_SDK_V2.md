...
| **Status** | Complete (B7 sem transição para trás, depois de corrigir o gabarito da `fase0-07`) |
...
| B7 | Eval Haiku N = 3 | (direct) | ✅ | US$ 7,89. A primeira leitura deu `mixed->fail` na `fase0-07`, porque o gabarito aceitava uma das duas regras que o catálogo sustenta. Com `also_accepted` e o baseline repontuado: 11 `pass->pass`, 1 `mixed->mixed`, 1 `fail->fail` |
...
| AT-012 | ✅ | 0 transições pass→fail/mixed, depois de corrigir o gabarito ambíguo da `fase0-07` (`also_accepted`, gate de conjunto em `check_evals.py`, baseline repontuado a partir dos transcripts) |

**Success Criteria:**
- SC1–SC4 ✅.
- SC5 ✅: depois da correção do gabarito da `fase0-07`.
- SC6 e SC7 ✅.
