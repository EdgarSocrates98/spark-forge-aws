...
| [`stepfunctions/execution-history.md`](stepfunctions/execution-history.md) | O que o **histórico de execução** prova: a forma de cada evento, como uma tentativa é pareada pelo encadeamento, o `JobRunId` do Glue, e o que as regras `SF-SFNX` afirmam — e o que elas recusam afirmar. Metade da lacuna de composição de retries acima já é mecanismo. Consome: `sparkforge/facts/sfn_history.py` e `rules/catalog/sfn-history.yaml` |
