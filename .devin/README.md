...
| Arquivo | O que faz |
|---|---|
| `mcp_config.json` | expõe as **91 tools** por stdio (recontado em 2026-09-12). Sem variável de ambiente — o `.mcp.json` da raiz é do plugin do Claude Code e usa `${CLAUDE_PLUGIN_ROOT}`, que nenhuma página do Devin documenta expandir |
